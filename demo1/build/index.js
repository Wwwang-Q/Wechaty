...
bot.on('scan', function (url, code) {
    ...
    var _ref = _asyncToGenerator(_regenerator2.default.mark(function _callee(contact, request) {
    ...
    var _ref2 = _asyncToGenerator(_regenerator2.default.mark(function _callee2(m) {
